...
import com.degard.imagecompressor.databinding.ActivitySettingsBinding
...
class SettingsActivity : AppCompatActivity() {
    ...
    private val doneReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (errors > 0) {
                Toast.makeText(this@SettingsActivity, "Completed with $errors errors", Toast.LENGTH_LONG).show()
            }
        }
    }
    ...
    private fun updateUI() {
        ...
        binding.btnStart.isEnabled = prefs.sourceUri != null && prefs.finalUri != null
    }
